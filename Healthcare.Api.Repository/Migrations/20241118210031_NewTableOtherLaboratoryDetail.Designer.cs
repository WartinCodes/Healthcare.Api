...
namespace Healthcare.Api.Repository.Migrations
{
    ...
    [Migration("20241118210031_NewTableOtherLaboratoryDetail")]
    partial class NewTableOtherLaboratoryDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Healthcare.Api.Core.Entities.OtherLaboratoryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdLaboratoryDetail")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdLaboratoryDetail");

                    b.ToTable("OtherLaboratoryDetail", "Healthcare");
                });
            ...
            modelBuilder.Entity("Healthcare.Api.Core.Entities.OtherLaboratoryDetail", b =>
                {
                    b.HasOne("Healthcare.Api.Core.Entities.LaboratoryDetail", "LaboratoryDetail")
                        .WithMany("OtherLaboratoryDetails")
                        .HasForeignKey("IdLaboratoryDetail")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LaboratoryDetail");
                });
            ...
            modelBuilder.Entity("Healthcare.Api.Core.Entities.LaboratoryDetail", b =>
                {
                    b.Navigation("OtherLaboratoryDetails");
                });
